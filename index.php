...
$nim = isset($_GET['nim']) ? mysqli_real_escape_string($conn, $_GET['nim']) : '2024081053';
...
<footer>
    <div class="social-media">
        <?php if($footer_data): ?>
            ...
            <?php if(!empty($footer_data['website_name'])): ?>
                <a href="<?= $footer_data['website_name']?>" target="_blank"><i class="fas fa-globe"></i> Website</a>
            <?php endif; ?>
        <?php else: ?>
    ...
    <div class="footer-center">©️ <?= date('Y')?> Profil Mahasiswa</div>
